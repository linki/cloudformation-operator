...
{{ include "cloudformation-operator.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "cloudformation-operator.selectorLabels" -}}
...
{{- default (include "cloudformation-operator.fullname" .) .Values.serviceAccount.name }}
{{- else }}
